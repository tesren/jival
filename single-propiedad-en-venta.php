    ...
    <article>
        ...
        <?php if ( have_posts() ): ?>
            ...
            <?php while( have_posts() ): the_post();?>
                        ...
                        <div class="col-11 col-lg-4 border-start border-danger mb-4 mb-lg-0 align-self-start">
                            <ul class="list-unstyled fs-4 fw-light">
                                ...
                                <?php if(rwmb_meta('construction')): ?>
                                    <li>
                                        <i class="fa-solid text-red fa-home"></i> <?= rwmb_meta('construction') ?> m²
                                    </li>
                                <?php endif; ?>
                ...
                <?php if( count($more_listings) > 0): ?>
                    <div class="container row justify-content-center mb-6">
                        <h3 class="col-12 text-center mb-5 fs-2 fw-normal"><?= pll_e('Más propiedades en venta') ?></h3>
